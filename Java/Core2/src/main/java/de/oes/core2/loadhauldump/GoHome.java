...
public class GoHome extends aCTIVITY {
	...
	public GoHome(Simulator sim, Number id, Number startTime, Number duration) {
		super(sim, id, null, startTime, duration, null);
		this.durationFunc = GoHome::duration;
		rESOURCErOLE rr = new rESOURCErOLE();
		rANGE range = new rANGE();
		range.setName("Truck");
		rr.setRange(range);
		GoHome.resRoles.put("trucks", rr);
	}
	
	public GoHome(Simulator sim) {
