...
@Component
public class RunServiceDeskSimulation {
	...
	public void run(SimulationSettingsDTO dto, org.springframework.ui.Model m) {
		...
		if(dto.getInit() == 0) { // (0) Basic scenario with one service desk
			scenario = initScenario(sim);
		} else { // (1) Scenario with two service desks
	...
	********************************************************/
	...
	private Scenario initAltScenario(Simulator sim) {
		...
		altScenario.setDurationInSimTime(1000l);
